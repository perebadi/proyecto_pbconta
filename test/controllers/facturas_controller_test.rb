...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { base_imponible: @factura.base_imponible, descuento: @factura.descuento, fecha_factura: @factura.fecha_factura, id_cliente: @factura.id_cliente, iva: @factura.iva, total: @factura.total }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { base_imponible: @factura.base_imponible, descuento: @factura.descuento, fecha_factura: @factura.fecha_factura, id_cliente: @factura.id_cliente, iva: @factura.iva, total: @factura.total }
    assert_redirected_to factura_path(assigns(:factura))
  end
